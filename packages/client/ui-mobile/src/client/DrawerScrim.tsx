...
export type DrawerScrimProps = PropsRuntime<'shell.overlay'> & DrawerScrimInjected & PropsLocale<'mobile'>
 ...
 */
export function DrawerScrim({ toggleSidebar, subscribe, snapshot, t }: DrawerScrimProps) {
  ...
  return (
    <button type="button" className={css.scrim} aria-label={t('drawer.close')} onClick={toggleSidebar} />
  )
}
