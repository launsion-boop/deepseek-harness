...
export type NewSessionMenuButtonProps = PropsRuntime<'shell.overlay'> & NewSessionMenuButtonInjected & PropsLocale<'mobile'>

/** Render the menu only while the regular conversation header is absent. */
export function NewSessionMenuButton({
  toggleSidebar, subscribe, snapshot, useSessions, t,
