...
export type HeaderMenuButtonProps = PropsRuntime<'conversation.session.header.actions'> & HeaderMenuButtonInjected & PropsLocale<'mobile'>
 ...
 */
export function HeaderMenuButton({ toggleSidebar, subscribe, snapshot, t }: HeaderMenuButtonProps) {
